...
/// <inheritdoc />
public partial class Sprint01IdentityAndTenancy : Migration
{
    private static readonly string[] UserOrganizationEmailIndexColumns = ["OrganizationId", "Email"];
    private static readonly string[] AuditLogOrganizationOccurredAtColumns = ["OrganizationId", "OccurredAtUtc"];
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(
            ...
            table: "AspNetUsers",
            columns: UserOrganizationEmailIndexColumns,
            unique: true,
        ...
        migrationBuilder.CreateIndex(
            ...
            table: "AuditLogs",
            columns: AuditLogOrganizationOccurredAtColumns);
