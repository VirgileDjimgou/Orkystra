# SPRINT-07 — Alertes et maintenance légère

## Objectif

Détecter les échéances et anomalies nécessitant une action.
...
- documents véhicule/conducteur et expirations
- maintenance planifiée kilométrage/date
- véhicule inactif
- règles d'alerte déterministes
- notifications in-app/email dev
- acquittement et assignation
...
- [ ] alertes non dupliquées
- [ ] fuseaux horaires testés
- [ ] permissions d'acquittement
- [ ] worker reprend après redémarrage
