# SPRINT-09 — Durcissement et pilote commercial

## Objectif

Déployer un MVP sécurisé, observable et récupérable.
...
- OpenTelemetry et alertes
- MFA admin
- rétention/export/suppression
- E2E complet
- guide onboarding et pilote
...
- [ ] scénario MVP complet automatisé
- [ ] tests charge baseline
- [ ] scan dépendances/secrets
- [ ] runbook incident
- [ ] trois utilisateurs pilotes peuvent être onboardés
